...
O navegador integrado falhou ao anexar a página. A validação visual completa do formulário e painel não foi concluída. Os resultados de API e RLS não substituem essa verificação.
