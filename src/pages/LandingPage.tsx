    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm border-b border-gray-100">
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          ...
          <Link to="/auth">
            <Button size="sm" className="bg-gray-900 hover:bg-gray-800 text-white border-0">
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-center mb-10 md:mb-12 text-gray-900">
          ...
          <div className="grid md:grid-cols-2 gap-6 md:gap-8 max-w-4xl mx-auto">
            {[
              ...
              <div key={index} className="flex gap-4 items-start bg-white p-5 md:p-6 rounded-xl shadow-sm">
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg md:text-xl text-gray-600 text-center mb-10 md:mb-12">O que está incluso</p>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="space-y-5 md:space-y-6">
              <div className="flex gap-4 items-start">
                <div className="flex-shrink-0 w-10 h-10 md:w-12 md:h-12 bg-gray-900 rounded-xl flex items-center justify-center">
                  <ClipboardCheck className="w-5 h-5 md:w-6 md:h-6 text-white" />
                </div>
                <div>
                  <h3 className="font-bold text-base md:text-lg text-gray-900">Plano alimentar 100% personalizado</h3>
                  <p className="text-gray-600 text-sm md:text-base">Um plano desenhado exclusivamente para você, considerando seu gasto calórico, rotina de treinos e objetivos de emagrecimento.</p>
                </div>
              </div>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <h3 className="font-bold text-base md:text-lg text-gray-900">Entrega rápida</h3>
                  <p className="text-gray-600 text-sm md:text-base">Seu plano é entregue em até 48 horas úteis após o preenchimento do formulário de diagnóstico.</p>
                </div>
              </div>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <h3 className="font-bold text-base md:text-lg text-gray-900">Check-up quinzenal de progresso</h3>
                  <p className="text-gray-600 text-sm md:text-base">A cada 15 dias, você preenche um check-up para avaliarmos peso, medidas e suas sensações. É o momento de solicitar ajustes.</p>
                </div>
              </div>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <h3 className="font-bold text-base md:text-lg text-gray-900">Suporte exclusivo no app</h3>
                  <p className="text-gray-600 text-sm md:text-base">Tire todas as suas dúvidas diretamente com o especialista pelo chat dentro do próprio aplicativo.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gray-900 text-white">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg md:text-xl text-gray-400 text-center mb-10 md:mb-12">Como funciona</p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 max-w-5xl mx-auto">
            {[
              ...
              <div key={index} className="text-center">
                <div className="w-12 h-12 md:w-16 md:h-16 bg-white text-gray-900 rounded-full flex items-center justify-center text-xl md:text-2xl font-bold mx-auto mb-3 md:mb-4">
                  {item.step}
                </div>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg md:text-xl text-gray-600 text-center mb-10 md:mb-12">Que vão turbinar seus resultados (valor inestimável)</p>
          
          <div className="grid md:grid-cols-2 gap-6 md:gap-8 max-w-4xl mx-auto">
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-6 md:p-8 rounded-2xl border-2 border-gray-200">
              <div className="inline-block bg-yellow-500 text-white text-sm font-bold px-3 py-1 rounded-full mb-4">
                BÔNUS 1
              </div>
              <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-3">Acesso à "Zona Nutri"</h3>
            ...
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-6 md:p-8 rounded-2xl border-2 border-gray-200">
              ...
              <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-3">Atividades comportamentais semanais</h3>
              <p className="text-gray-600 text-sm md:text-base">
                Receba um desafio prático por semana para ajudá-lo a construir hábitos, melhorar a adesão à dieta e garantir que o emagrecimento seja duradouro.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 md:py-20 bg-gray-900 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="max-w-md mx-auto">
            <a href={KIWIFY_LINK} target="_blank" rel="noopener noreferrer">
              <Button size="lg" className="w-full bg-green-600 hover:bg-green-700 text-white text-base md:text-lg py-6 rounded-lg shadow-lg mb-4">
      ...
      <footer className="py-8 bg-black text-gray-400 text-center text-sm">
        <div className="container mx-auto px-4">
          ...
          <Link to="/auth" className="text-white hover:text-gray-300 underline mt-2 inline-block">
            Área do Membro / Entrar
          </Link>
        </div>
      </footer>
